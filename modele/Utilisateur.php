...
class Utilisateur
{
    ...
    private $id;                        // identifiant de l'utilisateur (numéro automatique dans le BDD)
    ...
    public function setMdpSha1($mdpSha1) {$this->mdpSha1= $mdpSha1;}
    
    public function getAdrMail() {return $this->adrMail;}
    public function setAdrMail($adrMail) {$this->adrMail = $adrMail;}
    ...
    public function setNbTraces($nbTraces) {$this->nbTraces = $nbTraces;}

    public function getDateDerniereTrace() {return $this->dateDerniereTrace;}
    public function setDateDerniereTrace($dateDerniereTrace) {$this->dateDerniereTrace = $dateDerniereTrace;}
