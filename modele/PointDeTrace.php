...
class PointDeTrace extends Point
{
    ...
    public function setIdTrace($unidTrace){$this->latitude = $unidTrace;}

    public function getId(){return $this->id;}
    public function setId($unid){return $this->id = $unid;}

    public function getDateHeure(){return $this->dateHeure;}
    public function setDateHeure($uneDateHeure){return $this->dateHeure = $uneDateHeure;}
    
    public function getRythmeCardio(){return $this->rythmeCardio;}
    public function setRythmeCardio($unRythmeCardio){return $this->rythmeCardio = $unRythmeCardio;}

    public function getTempsCumule(){return $this->tempsCumule;}
    public function setTempsCumule($unTempsCumule){return $this->tempsCumule = $unTempsCumule;}
